...
description: 'Builds the connection between MindKey and the customer’s existing applications'
---
...
<Note>
**Note:** Replace THUMBPRINT and CUSTOMERID with the appropriate values provided by MindKey.
</Note>
...
<Note>
**Note:** To specify the position mode, use the positionMode parameter along with the desired positionVersion fields.
</Note>
...
<Note>
**Note:** Please note that renaming fields used in the API can cause scripts to fail as the field names and selections will be incorrect.
</Note>
